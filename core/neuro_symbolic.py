...
class NeuroSymbolicBridge:
    ...
    def bridge(self, neural_output: NeuralOutput, context: Dict[str, Any] = None) -> BridgedResult:
    ...
    def batch_bridge(self, outputs: List[NeuralOutput], context: Dict[str, Any] = None) -> List[BridgedResult]:
