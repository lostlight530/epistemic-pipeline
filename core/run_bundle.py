#!/usr/bin/env python3
"""Audited research-run wrapper for engine + trace/checkpoint + evidence artifacts.
...
from core.provenance import build_run_provenance, canonical_sha256, file_sha256, write_provenance
...
def main(argv=None) -> int:
    parser = argparse.ArgumentParser(
        description="Run an epistemic graph and emit PROV-aligned lineage plus a project evidence envelope"
    )
