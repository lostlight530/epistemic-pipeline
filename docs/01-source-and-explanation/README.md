...
The repository's maintenance scanner implementation remains in this class because executable source is classified by implementation role even when it supports class 03 maintenance/audit materials.
