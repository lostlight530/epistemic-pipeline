...
index = navigation + temporal/correction routing
```
...
No repository-local Stage correction record at initial close. The Stage itself records external benchmark/data corrections as research evidence.
...
- Re-read Stage A, B, C and D research sets, claim/evidence records, source registers, month reconstructions, reviews, syntheses, handoffs and the A→D longitudinal synthesis/current routing.
...
Stage F / 2025-Q2 extends the preserved A→E sequence to A→F.
...
- Research plane: claim/evidence/trajectory
...
- Stage F: APPEND_RELATION / Stage F / 2025-Q2 is the 2026-09-25 N-day input. It adds PaperBench long-horizon replication trajectory, Terminal-Bench concrete execution environment/tests, and tau2-bench second-actor/shared-world state.
...
- Stage F N-day meaning: Stage F / 2025-Q2 is the 2026-09-25 N-day input. It adds PaperBench long-horizon replication trajectory, Terminal-Bench concrete execution environment/tests, and tau2-bench second-actor/shared-world state.
...
- pass != truth
- score != scientific adjudication
- provenance != truth
- transfer != acceptance
- final outcome != complete execution explanation
...
- Cutoff: 2026-09-25
- Exact base main: `3c9b42cfb5f3b5d33ac851dd53f945945b374cfc`
- Scope: Stage A-F epistemic/evaluation lineage, longitudinal owner and retained stage packages.
...
- 2026-09-25: REVIEWED / RETAIN_STAGE_F_RELATION / NO_FOLLOW_UP. Stage F remains execution-trajectory research evidence, not claim truth or benchmark reproduction.

### Boundary
- indexed != true; evidence linked != sufficient; provenance != truth.
- transfer != acceptance; heuristic score != probability.
- current later-stage presence does not rewrite earlier availability or review identity.
